...
#ifndef SPOTIFY_SDK_SWIFT_H
#define SPOTIFY_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="spotify_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11spotify_sdk21SwiftSpotifySdkPlugin")
@interface SwiftSpotifySdkPlugin : NSObject <FlutterPlugin>
...
@interface SwiftSpotifySdkPlugin (SWIFT_EXTENSION(spotify_sdk))
